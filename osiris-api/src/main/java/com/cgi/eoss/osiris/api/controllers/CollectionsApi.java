...
import com.cgi.eoss.osiris.model.projections.ShortCollection;
...
public interface CollectionsApi extends BaseRepositoryApi<Collection>, CollectionsApiCustom, PagingAndSortingRepository<Collection, Long> {
    ...
    Page<Collection> parametricFind(@Param("filter") String filter, @Param("fileType") OsirisFile.Type fileType, @Param("owner") User user,@Param("notOwner") User notOwner, Pageable pageable);
