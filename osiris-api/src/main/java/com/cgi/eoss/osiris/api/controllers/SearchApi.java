...
/**
 * <p>Functionality for accessing the OSIRIS unifying search facade.</p>
 */
@RestController
...
public class SearchApi {
    ...
    private final OsirisFilesApiExtension osirisFilesApiExtension;
    private final OsirisFileDataService osirisFileDataService;

    @Autowired
    public SearchApi(SearchFacade searchFacade, ObjectMapper objectMapper, OsirisFilesApiExtension osirisFilesApiExtension, OsirisFileDataService osirisFileDataService) {
        ...
        this.osirisFilesApiExtension = osirisFilesApiExtension;
    ...
    public void downloadFile(@PathVariable("productSource") String productSource, @PathVariable("productIdentifier") String productIdentifier, HttpServletResponse response) throws IOException {
        switch (productSource) {
            case "osiris":
                osirisFilesApiExtension.downloadFile(osirisFileDataService.getById(Long.valueOf(productIdentifier)), response);
                break;
            default:
