...
import com.cgi.eoss.osiris.model.projections.ShortWalletTransaction;
...
public interface WalletTransactionsApi extends PagingAndSortingRepository<WalletTransaction, Long> {
    ...
    @Override
    @PostAuthorize("hasRole('ADMIN') or @osirisSecurityService.currentUser.equals(returnObject.owner)")
