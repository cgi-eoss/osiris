package com.cgi.eoss.osiris.api.security.dev;
...
@ConditionalOnProperty(value = "osiris.api.security.mode", havingValue = "DEVELOPMENT_BECOME_ANY_USER")
public class BecomeAnyUser {

    private final String usernameRequestAttribute;
    private final UserDataService userDataService;

    public BecomeAnyUser(@Value("${osiris.api.security.username-request-attribute:REMOTE_USER}") String usernameRequestAttribute, UserDataService userDataService) {
