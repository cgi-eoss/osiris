...
import com.cgi.eoss.osiris.io.ZipHandler;
...
public class CachingSymlinkDownloaderFacade implements DownloaderFacade {
    ...
    private static final Predicate<URI> ALWAYS_EVICT_URI = uri -> uri.toString().startsWith("osiris://databasket/") || uri.toString().startsWith("osiris://serviceContext/");
