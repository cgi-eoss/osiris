...
@Table(name = "osiris_costing_expressions",
        indexes = {@Index(name = "osiris_costing_expressions_type_associated_id_idx", columnList = "type, associated_id")},
        uniqueConstraints = {@UniqueConstraint(columnNames = {"type", "associated_id"})})
@NoArgsConstructor
@Entity
public class CostingExpression implements OsirisEntity<CostingExpression> {
    ...
    /**
     * <p>The ID of the associated entity, e.g. the {@link OsirisService#id} for {@link Type#SERVICE} or the {@link
