...
@Table(name = "osiris_data_sources",
        indexes = {@Index(name = "osiris_data_sources_name_idx", columnList = "name"), @Index(name = "osiris_data_sources_owner_idx", columnList = "owner")},
        uniqueConstraints = {@UniqueConstraint(columnNames = "name")})
@NoArgsConstructor
@Entity
public class DataSource implements OsirisEntityWithOwner<DataSource>, Searchable {
