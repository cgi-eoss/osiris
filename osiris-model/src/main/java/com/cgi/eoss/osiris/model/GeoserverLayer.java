...
@Table(name = "osiris_geoserver_layers",
        indexes = { @Index(name = "osiris_geoserver_layers_owner_idx", columnList = "owner"),
                @Index(name = "osiris_geoserver_layers_workspace_layer_idx", columnList = "workspace, layer")},
        uniqueConstraints = {@UniqueConstraint(columnNames = {"workspace", "layer"})}
)

@NoArgsConstructor
@Entity
public class GeoserverLayer implements OsirisEntityWithOwner<GeoserverLayer> {
    /**
