...
@Table(name = "osiris_worker_locator_expressions",
        indexes = {@Index(name = "osiris_worker_locator_expressions_service_idx", columnList = "service")},
        uniqueConstraints = {@UniqueConstraint(columnNames = {"service"})})
@NoArgsConstructor
@Entity
public class WorkerLocatorExpression implements OsirisEntity<WorkerLocatorExpression> {
    ...
    @Builder
    public WorkerLocatorExpression(OsirisService service, String expression) {
