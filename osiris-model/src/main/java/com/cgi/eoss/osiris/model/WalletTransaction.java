...
@Table(name = "osiris_wallet_transactions",
        indexes = {@Index(name = "osiris_wallet_transactions_wallet_idx", columnList = "wallet")})
@NoArgsConstructor
@Entity
public class WalletTransaction implements OsirisEntityWithOwner<WalletTransaction> {
    /**
    ...
    /**
     * <p>The ID of the associated action, e.g. the {@link Job#id} for {@link Type#JOB} or the {@link OsirisFile#id} for
    ...
    public enum Type {
        CREDIT(null), JOB(Job.class), DOWNLOAD(OsirisFile.class);
