...
@Table(name = "osiris_jobs",
        indexes = {@Index(name = "osiris_jobs_job_config_idx", columnList = "job_config"), @Index(name = "osiris_jobs_owner_idx", columnList = "owner")},
        uniqueConstraints = {@UniqueConstraint(columnNames = "ext_id")})
@NoArgsConstructor
@Entity
public class Job implements OsirisEntityWithOwner<Job> {
    ...
    /**
     * <p>URL to the graphical interface if this is a {@link OsirisService.Type#APPLICATION}.</p>
     */
    @Column(name = "gui_url")
    private String guiUrl;
    
    /**
     * <p>Backend endpoint for GUI if this is a {@link OsirisService.Type#APPLICATION}.</p>
     */
    ...
    /**
     * <p>The OsirisFiles produced as job outputs.</p>
     */
    @ManyToMany(fetch = FetchType.LAZY)
    @JoinTable(
            name = "osiris_job_output_files",
            joinColumns = @JoinColumn(name = "job_id", nullable = false),
            inverseJoinColumns = @JoinColumn(name = "file_id", nullable = false),
            indexes = @Index(name = "osiris_job_output_files_job_file_idx", columnList = "job_id, file_id", unique = true)
    )
    private Set<OsirisFile> outputFiles = new HashSet<>();
    ...
    public void addOutputFile(OsirisFile outputFile) {
