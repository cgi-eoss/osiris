...
@Table(name = "osiris_credentials",
        indexes = {@Index(name = "osiris_credentials_host_idx", columnList = "host")},
        uniqueConstraints = {@UniqueConstraint(columnNames = {"host"})})
@NoArgsConstructor
@Entity
public class DownloaderCredentials implements OsirisEntity<DownloaderCredentials> {
    ...
    /**
     * <p>Generic data field for credentials</p>
     */
    @Lob
    @Column(name = "data")
    private String data;
