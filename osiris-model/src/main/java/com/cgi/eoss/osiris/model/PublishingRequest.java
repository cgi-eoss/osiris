...
@Table(name = "osiris_publishing_requests",
        indexes = {@Index(name = "osiris_publishing_requests_owner_idx", columnList = "owner")},
        uniqueConstraints = {@UniqueConstraint(name = "osiris_publishing_requests_owner_object_idx", columnNames = {"owner", "type", "associated_id"})})
@NoArgsConstructor
@Entity
public class PublishingRequest implements OsirisEntityWithOwner<PublishingRequest> {
    /**
     ...
     * the {@link OsirisService#id} for {@link Type#SERVICE}.</p>
     */
    ...
    public enum Type {
        ...
        FILE(OsirisFile.class),
        SERVICE(OsirisService.class),
        GROUP(Group.class),
        JOB_CONFIG(JobConfig.class),
        PROJECT(Project.class),
        SERVICE_TEMPLATE(OsirisServiceTemplate.class), 
