...
/**
 * <p>
 * OSIRIS User Mounts. Defines additional Docker mount points available to users
 * </p>
 */
@Data
@EqualsAndHashCode(exclude = {"id"})
@Table(name = "osiris_user_mounts",
        indexes = {@Index(name = "osiris_user_mounts_owner_idx", columnList = "owner"),
                @Index(name = "osiris_user_mounts_name_idx", columnList = "name")},
        uniqueConstraints = {@UniqueConstraint(name = "osiris_user_mounts_name_owner_idx",
                columnNames = {"name", "owner"})})
@NoArgsConstructor
@Entity
public class UserMount implements OsirisEntityWithOwner<UserMount> {
    /**
     * <p>
