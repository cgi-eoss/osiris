...
TRAINING_OUTPUT_CLASSIFICATION_MODEL="${OUT_DIR}/model/OSIRIS_LANDCOVERS2_${TIMESTAMP}_training_model.txt"
TRAINING_OUTPUT_CONFUSION_MATRIX_CSV="${OUT_DIR}/confusionMatrix/OSIRIS_LANDCOVERS2_${TIMESTAMP}_confusion_matrix.csv"
OUTPUT_FILE="${OUT_DIR}/result/OSIRIS_LANDCOVERS2_${TIMESTAMP}.tif"
