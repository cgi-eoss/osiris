...
import com.cgi.eoss.osiris.worker.WorkerConfig;
import com.cgi.eoss.osiris.worker.WorkerTestConfig;
...
public class OsirisWorkerIT {
    ...
    @Autowired
    private OsirisWorker worker;

    private Server server;

    private OsirisWorkerGrpc.OsirisWorkerBlockingStub workerClient;
    ...
    public void setUp() throws IOException {
        ...
        workerClient = OsirisWorkerGrpc.newBlockingStub(channelBuilder.build());
