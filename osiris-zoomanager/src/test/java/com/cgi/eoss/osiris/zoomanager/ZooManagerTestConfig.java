...
public class ZooManagerTestConfig {
    ...
    @Bean
    public Path zcfgBasePath(@Value("${osiris.zoomanager.zcfg.path:/var/www/cgi-bin}") String zcfgBasePath) throws IOException {
    ...
    @Bean
    public Path zooServicesStubJar(@Value("${osiris.zoomanager.stub.jarFile:/var/www/cgi-bin/jars/osiris-services.jar}") String zooServicesStubJar) throws IOException {
