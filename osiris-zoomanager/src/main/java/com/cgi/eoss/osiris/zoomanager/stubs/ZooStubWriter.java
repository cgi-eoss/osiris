...
/**
 * <p>Utility to generate ZOO-Project WPS service implementations from {@link OsirisServiceDescriptor} objects.</p>
 */
@FunctionalInterface
public interface ZooStubWriter {
     ...
     */
    void generateWpsStubLibrary(Set<OsirisServiceDescriptor> services, Path jar);
