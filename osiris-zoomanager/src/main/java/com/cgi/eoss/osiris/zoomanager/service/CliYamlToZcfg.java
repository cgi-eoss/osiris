...
import com.cgi.eoss.osiris.zoomanager.zcfg.ZcfgWriterImpl;
...
public class CliYamlToZcfg {
    ...
    private static final YamlOsirisServiceDescriptorHandler YAML = new YamlOsirisServiceDescriptorHandler();
    ...
    public static void main(String[] args) {
        ...
        OsirisServiceDescriptor svc = YAML.readFile(inputYaml);
