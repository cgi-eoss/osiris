...
import com.cgi.eoss.osiris.rpc.UpdateActiveZooServicesResult;
import com.cgi.eoss.osiris.rpc.WpsServiceDescriptors;
import com.cgi.eoss.osiris.rpc.ZooManagerServiceGrpc;
import com.cgi.eoss.osiris.zoomanager.stubs.ZooStubWriter;
import com.cgi.eoss.osiris.zoomanager.zcfg.ZcfgWriter;
...
public class ZooManagerService extends ZooManagerServiceGrpc.ZooManagerServiceImplBase {
    ...
    @Autowired
    public ZooManagerService(ZooStubWriter zooStubWriter, OsirisServiceDescriptorHandler serviceDescriptorHandler, ZcfgWriter zcfgWriter,
    ...
    public void updateActiveZooServices(WpsServiceDescriptors request, StreamObserver<UpdateActiveZooServicesResult> responseObserver) {
        try {
            ...
            Set<OsirisServiceDescriptor> services = request.getServicesList().stream()
                    .map(d -> OsirisServiceDescriptor.fromYaml(d.getContent().toStringUtf8()))
