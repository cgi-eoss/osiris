...
/**
 * <p>A service for provisioning OSIRIS compute nodes. Implementations of this may work with physical, virtual, or local
 * computing resources, e.g. to instantiate new VMs.</p>
 * <p>Nodes configured by this service should provide the parameters necessary for the OSIRIS Worker component to create
 * a Docker client.</p>
 */
public interface NodeFactory {

    /**
     * <p>Provision a Node suitable for running OSIRIS services with Docker. This call will block until the requested
