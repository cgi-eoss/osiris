...
public class OsirisWebClient {
    ...
    private final OsirisHarness harness;
    private final OkHttpClient httpClient;

    public OsirisWebClient(OsirisHarness osirisHarness) {
        harness = osirisHarness;
    ...
    public void load(OsirisPage page) {
        load(page.getUrl());
    }
    ...
    public void openPanel(OsirisPanel panel) {
    ...
    public void click(OsirisClickable button) {
    ...
    public void enterText(OsirisFormField formField, String input) {
    ...
    private String getUrl(String path) {
        return harness.getOsirisBaseUrl() + path;
    }
