...
public class UserPreferenceDataServiceIT {
    ...
    public void test() throws Exception {
        ...
        assertThat(
                dataService.getByIds(
                        ImmutableSet.of(pref_name1_owner.getId(), pref2_name2_owner2.getId())),
                is(ImmutableList.of(pref_name1_owner, pref2_name2_owner2)));
        ...
        UserPreference pref_name1_owner_duplicate =
                new UserPreference(name1, "prefType", "prefValue");
        ...
        assertThat(dataService.findByTypeAndOwner("prefType", owner),
                is(ImmutableList.of(pref_name1_owner)));

        UserPreference longString =
                new UserPreference("long", "longString", zeroesStringOfLength(40000));
    ...
    public void testPreferenceTooLong() {
        UserPreference tooLongString =
                new UserPreference("tooLong", "longString", zeroesStringOfLength(100000));
        User owner = new User("owner-uid");
