...
public class ServiceDataServiceIT {
    ...
    public void test() throws Exception {
        ...
        assertThat(dataService.isUniqueAndValid(new OsirisService("Test Service", owner, "dockerTag")), is(false));
        assertThat(dataService.isUniqueAndValid(new OsirisService("Test Service2", owner, "dockerTag")), is(true));
