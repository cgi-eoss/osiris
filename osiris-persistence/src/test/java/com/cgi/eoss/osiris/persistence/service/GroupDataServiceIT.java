...
public class GroupDataServiceIT {
    ...
    public void test() throws Exception {
        ...
        assertThat(dataService.isUniqueAndValid(new Group("Test Group", owner)), is(false));
        assertThat(dataService.isUniqueAndValid(new Group("Test Group3", owner)), is(true));
        assertThat(dataService.isUniqueAndValid(new Group("Test Group", owner2)), is(true));
        ...
        assertThat(dataService.findByOwner(owner), containsInAnyOrder(group, group2));
