...
public class ServiceFileDataServiceIT {
    ...
    public void test() throws Exception {
        ...
        OsirisService svc = new OsirisService();
        ...
        OsirisServiceContextFile serviceFile = new OsirisServiceContextFile();
        ...
        assertThat(dataService.isUniqueAndValid(new OsirisServiceContextFile(svc, "Dockerfile")), is(false));
        assertThat(dataService.isUniqueAndValid(new OsirisServiceContextFile(svc, "Dockerfile2")), is(true));
    ...
    public void testServiceFingerprint() throws Exception {
        ...
        OsirisService svc2 = new OsirisService();
