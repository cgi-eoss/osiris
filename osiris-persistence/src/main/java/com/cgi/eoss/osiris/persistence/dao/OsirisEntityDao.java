...
import com.cgi.eoss.osiris.persistence.SpringJpaRepositoryIgnore;
...
/**
 * <p>A generic DAO interface for OSIRIS entity objects.</p>
 *
...
public interface OsirisEntityDao<T extends OsirisEntity<T>> extends JpaRepository<T, Long>, QueryDslPredicateExecutor<T> {
