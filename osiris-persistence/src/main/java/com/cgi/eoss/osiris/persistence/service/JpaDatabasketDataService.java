...
import com.cgi.eoss.osiris.persistence.dao.DatabasketDao;
...
import static com.cgi.eoss.osiris.model.QDatabasket.databasket;
...
public class JpaDatabasketDataService extends AbstractJpaDataService<Databasket> implements DatabasketDataService {
    ...
    @Override
    OsirisEntityDao<Databasket> getDao() {
        return dao;
    }
    ...
    @Override
    public List<Databasket> findByFile(OsirisFile file) {
