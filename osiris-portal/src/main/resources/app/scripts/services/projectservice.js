...
define(['../osirismodules', 'traversonHal'], function (osirismodules, TraversonJsonHalAdapter) {
    ...
    osirismodules.service('ProjectService', [ 'osirisProperties', 'MessageService', 'CommunityService', 'UserService', 'traverson', '$q', '$rootScope', '$timeout', function (osirisProperties, MessageService, CommunityService, UserService, traverson, $q, $rootScope, $timeout) {
