...
define(['../osirismodules', 'traversonHal'], function (osirismodules, TraversonJsonHalAdapter) {
    ...
    osirismodules.service('UserService', [ 'osirisProperties', '$rootScope', '$q', 'MessageService', 'traverson', '$mdDialog', '$window', '$timeout', function (osirisProperties, $rootScope, $q, MessageService, traverson, $mdDialog, $window, $timeout) {
        ...
        this.checkLoginStatus = function() {
            halAPI.from(osirisProperties.URLv2 + '/users/current')
            .newRequest()
            .getResource()
            .result
            .then(function (user) {
