/**
 * @ngdoc service
 * @name osirisApp.CommunityService
 * @description
 * # CommunityService
...
define(['../osirismodules'], function (osirismodules) {
    ...
    osirismodules.service('CommunityService', ['osirisProperties', 'MessageService', '$http', '$q',  function (osirisProperties, MessageService, $http, $q) {
