/**
 * @ngdoc service
 * @name osirisApp.PublishingService
 * @description
 * # PublishingService
...
define(['../osirismodules', 'traversonHal'], function (osirismodules, TraversonJsonHalAdapter) {
    ...
    osirismodules.service('PublishingService', [ 'MessageService', 'osirisProperties', '$q', 'traverson', '$mdDialog', function (MessageService, osirisProperties, $q, traverson, $mdDialog) {
