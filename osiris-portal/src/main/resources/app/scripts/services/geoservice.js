...
define(['../osirismodules'], function (osirismodules) {
    ...
    osirismodules.service('GeoService', ['$http', '$rootScope', 'osirisProperties', '$q', 'MessageService', 'MapService', function ($http, $rootScope, osirisProperties, $q, MessageService, MapService) {
        ...
        this.getGeoResults = function (pageNumber) {
            ...
            $http({
                method: 'GET',
                url: osirisProperties.URL + '/search',
                params: params,
