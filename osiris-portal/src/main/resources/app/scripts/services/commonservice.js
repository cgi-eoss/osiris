...
define(['../osirismodules'], function (osirismodules) {
    ...
    osirismodules.service('CommonService', ['$rootScope', 'osirisProperties', '$mdDialog', '$q', '$injector', function ($rootScope, osirisProperties, $mdDialog, $q, $injector) {
