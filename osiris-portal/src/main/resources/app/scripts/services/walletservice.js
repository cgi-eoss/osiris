...
define(['../osirismodules', 'traversonHal'], function (osirismodules, TraversonJsonHalAdapter) {
    ...
    osirismodules.service('WalletService', [ 'osirisProperties', '$q', 'traverson', 'MessageService', function (osirisProperties, $q, traverson, MessageService) {
