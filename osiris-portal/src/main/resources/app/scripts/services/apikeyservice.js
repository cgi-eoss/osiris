...
define(['../osirismodules'], function(osirismodules) {
    ...
    osirismodules.service('ApiKeyService', ['$rootScope', '$http', 'osirisProperties', '$q', '$timeout', 'MessageService', 'UserService', function($rootScope, $http, osirisProperties, $q, $timeout, MessageService, UserService) {
