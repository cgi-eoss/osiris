...
define(['../osirismodules', 'traversonHal', 'moment'], function (osirismodules, TraversonJsonHalAdapter, moment) {
    ...
    osirismodules.service('SearchService', ['osirisProperties', '$http', '$q', 'MessageService', 'traverson', function (osirisProperties, $http, $q, MessageService, traverson) {
