...
define([
    ...
    app.constant('osirisProperties', {
        'OSIRIS_URL': osirisConfig.osirisUrl,
        'OSIRIS_PORTAL_URL': osirisConfig.osirisPortalUrl,
    ...
    app.init = function () {
        angular.bootstrap(document, ['osirisApp']);
        require([
    ...
    app.directive('osirisPaging', function () {
        return {
            restrict: 'EA',
            templateUrl: 'views/common/templates/paging.tmpl.html',
            link: function ($scope, element, attrs) {

                $scope.pagingData = JSON.parse(attrs.osirisPaging);
                ...
                attrs.$observe('osirisPaging', function() {
                    $scope.pagingData = JSON.parse(attrs.osirisPaging);
                });
