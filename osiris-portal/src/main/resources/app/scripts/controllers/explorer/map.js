/**
* @ngdoc function
* @name osirisApp.controller:MapCtrl
* @description
* # MapCtrl
* Controller of the osirisApp
*/
define(['../../osirismodules', 'ol', 'x2js', 'clipboard'], function (osirismodules, ol, X2JS, clipboard) {
    'use strict';

    osirismodules.controller('MapCtrl', [ '$scope', '$element', '$rootScope', '$mdDialog', 'osirisProperties', 'MapService', 'AoiService', 'AoiLayerService', 'ResultLayerService', 'BasketLayerService', 'ProductLayerService', 'SearchService', '$timeout', function($scope, $element, $rootScope, $mdDialog, osirisProperties, MapService, aoiService, aoiLayer, resultLayer, basketLayer, productLayer, searchService, $timeout) {
