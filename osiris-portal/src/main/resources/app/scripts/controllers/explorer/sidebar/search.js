...
/**
 * @ngdoc function
 * @name osirisApp.controller:SearchbarCtrl
 * @description
 * # SearchbarCtrl
...
define(['../../../osirismodules'], function (osirismodules) {
    ...
    osirismodules.controller('SearchbarCtrl', ['$scope', '$rootScope', '$http', 'CommonService', 'BasketService', 'MapService','AoiLayerService', 'SearchService', 'moment', function ($scope, $rootScope, $http, CommonService, BasketService, MapService, AoiLayerService, SearchService, moment) {
