/**
 * @ngdoc function
 * @name osirisApp.controller:ServicesCtrl
 * @description
 * # ServicesCtrl
...
define(['../../../osirismodules'], function (osirismodules) {
    ...
    osirismodules.controller('ServicesCtrl', ['$scope', '$rootScope', '$sce', 'ProductService', 'TabService', function ($scope, $rootScope, $sce, ProductService, TabService) {
