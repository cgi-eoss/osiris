/**
 * @ngdoc function
 * @name osirisApp.controller:AdminCtrl
 * @description
 * # AdminCtrl
...
define(['../../osirismodules'], function (osirismodules) {
    ...
    osirismodules.controller('AdminCtrl', ['$scope', 'UserService', 'MessageService', 'WalletService', 'TabService', function ($scope, UserService, MessageService, WalletService, TabService) {
