...
define(['../../../osirismodules'], function (osirismodules) {
    ...
    osirismodules.controller('DeveloperManageTemplateCtrl', ['$scope', 'ProductService', 'ProductTemplateService', 'DeveloperTemplatesCtrlState', 'UserMountsService', 'CommonService', '$mdDialog', function ($scope, ProductService, ProductTemplateService, DeveloperTemplatesCtrlState, UserMountsService, CommonService, $mdDialog) {
