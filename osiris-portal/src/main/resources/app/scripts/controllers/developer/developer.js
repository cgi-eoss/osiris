/**
 * @ngdoc function
 * @name osirisApp.controller:DeveloperCtrl
 * @description
 * # DeveloperCtrl
...
define(['../../osirismodules'], function (osirismodules) {
    ...
    osirismodules.controller('DeveloperCtrl', ['$scope', 'TabService', 'MessageService', 'CommonService', function ($scope, TabService, MessageService, CommonService) {
