/**
 * @ngdoc function
 * @name osirisApp.controller:DeveloperTemplatesCtrl
 * @description
 * # ServiceCtrl
...
define(['../../../osirismodules'], function (osirismodules) {
    ...
    osirismodules.controller('DeveloperTemplatesCtrl', ['$scope', 'ProductService', 'ProductTemplateService', 'DeveloperTemplatesCtrlState', 'UserMountsService', 'CommonService', '$mdDialog', '$q', function ($scope, ProductService, ProductTemplateService, DeveloperTemplatesCtrlState, UserMountsService, CommonService, $mdDialog, $q) {
