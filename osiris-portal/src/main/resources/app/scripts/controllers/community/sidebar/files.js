/**
 * @ngdoc function
 * @name osirisApp.controller:CommunityFilesCtrl
 * @description
 * # CommunityFilesCtrl
...
define(['../../../osirismodules'], function (osirismodules) {
    ...
    osirismodules.controller('CommunityFilesCtrl', ['FileService', 'CommonService', '$scope', '$mdDialog', 'moment', function (FileService, CommonService, $scope, $mdDialog, moment) {
        ...
        $scope.$on('poll.osirisfiles', function (event, data) {
        ...
        $scope.removeItem = function (event, key, item) {
            CommonService.confirm(event, 'Are you sure you want to delete this file?').then(function (confirmed) {
                if (confirmed !== false) {
                    FileService.removeOsirisFile(item).then(function (data) {
                        /* Update list of files */
                        FileService.refreshOsirisFiles("community", "Remove", item);
                    });
                }
            });
        };
