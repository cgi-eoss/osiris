/**
 * @ngdoc function
 * @name osirisApp.controller:CommunityManageServiceCtrl
 * @description
...
define(['../../../osirismodules'], function (osirismodules) {
    ...
    osirismodules.controller('CommunityManageServiceCtrl', ['CommunityService', 'ProductService', '$scope', function (CommunityService, ProductService, $scope) {
