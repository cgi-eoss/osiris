...
define(['../../../osirismodules'], function (osirismodules) {
    ...
    osirismodules.controller('CommunityManageJobCtrl', ['CommunityService', 'JobService', 'CommonService', '$scope', function (CommunityService, JobService, CommonService, $scope) {
