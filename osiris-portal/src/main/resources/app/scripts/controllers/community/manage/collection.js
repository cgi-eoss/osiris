...
define(['../../../osirismodules'], function (osirismodules) {
    ...
    osirismodules.controller('CommunityManageCollectiontCtrl', ['CollectionService', 'FileService', 'CommunityService', '$scope', '$mdDialog', function (CollectionService, FileService, CommunityService, $scope, $mdDialog) {
