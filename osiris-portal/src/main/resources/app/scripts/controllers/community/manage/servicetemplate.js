/**
 * @ngdoc function
 * @name osirisApp.controller:CommunityManageServiceTemplateCtrl
 * @description
...
define(['../../../osirismodules'], function (osirismodules) {
    ...
    osirismodules.controller('CommunityManageServiceTemplateCtrl', ['CommunityService', 'ProductTemplateService', 'DeveloperTemplatesCtrlState', 'TabService', '$scope', function (CommunityService, ProductTemplateService, DeveloperTemplatesCtrlState, TabService, $scope) {
