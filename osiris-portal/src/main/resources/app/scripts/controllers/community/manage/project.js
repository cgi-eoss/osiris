/**
 * @ngdoc function
 * @name osirisApp.controller:CommunityManageProjectCtrl
 * @description
...
define(['../../../osirismodules'], function (osirismodules) {
    ...
    osirismodules.controller('CommunityManageProjectCtrl', ['CommunityService', 'ProjectService', '$scope', '$mdDialog', function (CommunityService, ProjectService, $scope, $mdDialog) {
