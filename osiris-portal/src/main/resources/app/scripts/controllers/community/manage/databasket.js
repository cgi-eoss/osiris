...
define(['../../../osirismodules'], function (osirismodules) {
    ...
    osirismodules.controller('CommunityManageDatabasketCtrl', ['BasketService', 'FileService', 'CommunityService', '$scope', '$mdDialog', function (BasketService, FileService, CommunityService, $scope, $mdDialog) {
        ...
        $scope.addItemsDialog = function($event) {
            function AddItemsController($scope, $mdDialog, BasketService, FileService) {
                ...
                $scope.selectDatasource = function (datasource) {
                    ...
                    FileService.getOsirisFiles('community', FileService.params.community.activeFileType).then(function (data) {
