/**
 * @ngdoc function
 * @name osirisApp.controller:CommunityManageGroupCtrl
 * @description
...
define(['../../../osirismodules'], function (osirismodules) {
    ...
    osirismodules.controller('CommunityManageGroupCtrl', ['CommunityService', 'GroupService', 'UserService', '$scope', '$mdDialog', function (CommunityService, GroupService, UserService, $scope, $mdDialog) {
                ...
                $scope.addUser = function(group, user) {
                    ...
                    if ($scope.validateUser(user)) {
                        UserService.addUser(group, $scope.userParams.groupUsers, user).then(function (data) {
                            ...
                            $scope.userParams.searchText = null;
