/**
 * @ngdoc function
 * @name osirisApp.controller:CommunityProjectsCtrl
 * @description
...
define(['../../../osirismodules'], function (osirismodules) {
    ...
    osirismodules.controller('CommunityProjectsCtrl', ['ProjectService', 'CommonService', '$scope', function (ProjectService, CommonService, $scope) {
