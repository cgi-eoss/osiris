/**
 * @ngdoc function
 * @name osirisApp.controller:CommunityServicesCtrl
 * @description
...
define(['../../../osirismodules'], function (osirismodules) {
    ...
    osirismodules.controller('CommunityServicesCtrl', ['ProductService', 'PublishingService', 'CommonService', '$scope', '$mdDialog', function (ProductService, PublishingService, CommonService, $scope, $mdDialog) {
        ...
        $scope.publishService = function ($event, service) {
            PublishingService.publishItemDialog($event, service, 'services', function() {
                ProductService.refreshServices("community");
            });
        };
