/**
 * @ngdoc function
 * @name osirisApp.controller:CommunityGroupsCtrl
 * @description
 * # CommunityGroupsCtrl
...
define(['../../../osirismodules'], function (osirismodules) {
    ...
    osirismodules.controller('CommunityGroupsCtrl', ['GroupService', 'CommonService', '$scope', function (GroupService, CommonService, $scope) {
