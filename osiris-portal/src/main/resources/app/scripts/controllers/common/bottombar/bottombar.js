/**
 * @ngdoc function
 * @name osirisApp.controller:BottombarCtrl
 * @description
 * # BottombarCtrl
...
define(['../../../osirismodules'], function (osirismodules) {
    osirismodules.controller('BottombarCtrl', [ '$scope', '$rootScope', '$q', 'CommonService', 'TabService', 'BasketService', 'JobService', 'SearchService', 'FileService', 'MessageService', '$mdDialog', function($scope, $rootScope, $q, CommonService, TabService, BasketService, JobService, SearchService, FileService, MessageService, $mdDialog) {
