/**
 * @ngdoc function
 * @name osirisApp.controller:ResultsCtrl
 * @description
 * # ResultsCtrl
...
define(['../../../osirismodules'], function (osirismodules) {
    ...
    osirismodules.controller('ResultsCtrl', [ '$scope', '$rootScope', '$anchorScroll', '$timeout', 'SearchService', 'TabService', 'CommonService', 'ResultLayerService', function($scope, $rootScope, $anchorScroll, $timeout, SearchService, TabService, CommonService, ResultLayerService) {
