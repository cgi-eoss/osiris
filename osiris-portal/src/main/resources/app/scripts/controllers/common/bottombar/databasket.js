/**
 * @ngdoc function
 * @name osirisApp.controller:DatabasketCtrl
 * @description
 * # DatabasketCtrl
...
define(['../../../osirismodules'], function(osirismodules) {
    ...
    osirismodules.controller('DatabasketCtrl', ['$scope', '$rootScope', '$mdDialog', 'CommonService', 'BasketService', 'TabService', '$location', function($scope, $rootScope, $mdDialog, CommonService, BasketService, TabService, $location) {
