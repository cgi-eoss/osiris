define(['../../../osirismodules','ol', 'shp', 'clipboard'], function (osirismodules, ol, shp, clipboard) {
    'use strict';

    osirismodules.directive('aoiField', ['AoiService', 'AoiLayerService', 'CommonService', '$mdDialog', '$mdPanel', function(aoiService, aoiLayerService, commonService, $mdDialog, $mdPanel) {
        return {
            scope: {
                label: '=',
                description: '=',
