/**
 * @ngdoc function
 * @name osirisApp.controller:AccountCtrl
 * @description
 * # AccountCtrl
...
define(['../../osirismodules'], function (osirismodules) {
    ...
    osirismodules.controller('AccountCtrl', ['osirisProperties', '$scope', 'UserService', 'ApiKeyService', 'WalletService', 'TabService', 'MessageService', '$mdDialog', function (osirisProperties, $scope, UserService, ApiKeyService, WalletService, TabService, MessageService, $mdDialog) {
